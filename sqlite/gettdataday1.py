...
for idx, val in j.items():
    ...
    tlist.append(['Bil', 'DP', yesterday, thour[x], int(val['DP']['Bil'])])
    ...
    tlist.append(['Bil', 'CR', yesterday, thour[x], int(val['Crucial']['Bil'])])
    ...
    tlist.append(['Bil', 'PA', yesterday, thour[x], int(val['Panthur']['Bil'])])
    x += 1

# name of the sqlite database file
sqlite_file = 'tdatamaster.sqlite'    
